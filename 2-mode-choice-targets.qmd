...
# Export mode control
# Options:
#   "all"     : Export all variables
#   "comment" : Export all variables, but comment out the ones not needed
#   "needed"  : Export only the variables that are needed for TDM
EXPORT_MODE = "needed"
...
## Compute CRT Class Proportions by Purpose
...
```{python}
def export_calib_file(purpose, period, export_mode="needed", remove_all_suffix=False):
    """
    ...
    export_mode : str
        Export mode: "all", "comment", "needed"
    ...
    with open(filepath, 'w') as f:
        ...
        # Write disclaimer - only for all and comment modes
        if export_mode in ["all", "comment"]:
