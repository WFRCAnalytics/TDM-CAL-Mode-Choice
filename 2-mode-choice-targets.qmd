...
flowchart LR
  ...
  subgraph S1["🚗 Motorized Transportation"]
    ...
    subgraph S1a["🚌 Transit – By Service Type"]
      ...
      TM --> CRT["CRT 00-08<br/><i>commuter rail</i>"]
...
# Process OBS to classify CRT by distances

```{python}
# Create Linked_Mode_txt_crt column
df_obs_linked['Linked_Mode_txt_crt'] = np.where(
    df_obs_linked['Linked_Mode_txt'] == 'CRT',
    df_obs_linked['class_CRT'],
    df_obs_linked['Linked_Mode_txt']
)

df_obs_linked[['Linked_Mode_txt', 'class_CRT', 'Linked_Mode_txt_crt']]
```
...
obs_transit = df_obs_linked[df_obs_linked['Linked_Mode_txt_crt'] != 'MT'].copy()
```
...
df_obs_transit = (
    df_obs_linked[df_obs_linked['Linked_Mode_txt_crt'] != 'MT']
...
df_transit_by_service = calculate_categorical_shares(
    df_obs_linked,
    category_col='Linked_Mode_txt_crt',
    weight_col='trip_weight',
    group_cols=['Veh_Cat3p', 'Purp5_text', 'PK_OK'],
    filter_condition='Linked_Mode_txt_crt != "MT"',
...
df_walk_to_transit = calculate_categorical_shares(
    ...
    weight_col='trip_weight',
    group_cols=['Veh_Cat3p', 'Purp5_text', 'PK_OK'],
    filter_condition='Ac_Mode2_Model == "Walk" & Linked_Mode_txt_crt != "MT"',
...
df_drive_to_transit = calculate_categorical_shares(
    ...
    weight_col='trip_weight',
    group_cols=['Veh_Cat3p', 'Purp5_text', 'PK_OK'],
    filter_condition='Ac_Mode2_Model == "Drive" & Linked_Mode_txt_crt != "MT"',
...
def create_tree_dataframe(
    ...
    wcrt00_share = get_value(df_walk_to_transit, 'wcrt00', purpose, veh_cat, period)
    wcrt01_share = get_value(df_walk_to_transit, 'wcrt01', purpose, veh_cat, period)
    wcrt02_share = get_value(df_walk_to_transit, 'wcrt02', purpose, veh_cat, period)
    wcrt03_share = get_value(df_walk_to_transit, 'wcrt03', purpose, veh_cat, period)
    wcrt04_share = get_value(df_walk_to_transit, 'wcrt04', purpose, veh_cat, period)
    wcrt05_share = get_value(df_walk_to_transit, 'wcrt05', purpose, veh_cat, period)
    wcrt06_share = get_value(df_walk_to_transit, 'wcrt06', purpose, veh_cat, period)
    wcrt07_share = get_value(df_walk_to_transit, 'wcrt07', purpose, veh_cat, period)
    wcrt08_share = get_value(df_walk_to_transit, 'wcrt08', purpose, veh_cat, period)
    ...
    dcrt00_share = get_value(df_drive_to_transit, 'dcrt00', purpose, veh_cat, period)
    dcrt01_share = get_value(df_drive_to_transit, 'dcrt01', purpose, veh_cat, period)
    dcrt02_share = get_value(df_drive_to_transit, 'dcrt02', purpose, veh_cat, period)
    dcrt03_share = get_value(df_drive_to_transit, 'dcrt03', purpose, veh_cat, period)
    dcrt04_share = get_value(df_drive_to_transit, 'dcrt04', purpose, veh_cat, period)
    dcrt05_share = get_value(df_drive_to_transit, 'dcrt05', purpose, veh_cat, period)
    dcrt06_share = get_value(df_drive_to_transit, 'dcrt06', purpose, veh_cat, period)
    dcrt07_share = get_value(df_drive_to_transit, 'dcrt07', purpose, veh_cat, period)
    dcrt08_share = get_value(df_drive_to_transit, 'dcrt08', purpose, veh_cat, period)
    ...
    rows.append({
        ...
        'level3': 'Walk-to-Transit',
        'level4': 'CRT_00',
        'value': walk_transit_base * wcrt00_share
    })
    ...
    rows.append({
        ...
        'level3': 'Walk-to-Transit',
        'level4': 'CRT_01',
        'value': walk_transit_base * wcrt01_share
    })
    ...
    rows.append({
        ...
        'level3': 'Walk-to-Transit',
        'level4': 'CRT_02',
        'value': walk_transit_base * wcrt02_share
    })
    ...
    rows.append({
        ...
        'level3': 'Walk-to-Transit',
        'level4': 'CRT_03',
        'value': walk_transit_base * wcrt03_share
    })
    ...
    rows.append({
        ...
        'level3': 'Walk-to-Transit',
        'level4': 'CRT_04',
        'value': walk_transit_base * wcrt04_share
    })
    ...
    rows.append({
        ...
        'level3': 'Walk-to-Transit',
        'level4': 'CRT_05',
        'value': walk_transit_base * wcrt05_share
    })
    ...
    rows.append({
        ...
        'level3': 'Walk-to-Transit',
        'level4': 'CRT_06',
        'value': walk_transit_base * wcrt06_share
    })
    ...
    rows.append({
        ...
        'level3': 'Walk-to-Transit',
        'level4': 'CRT_07',
        'value': walk_transit_base * wcrt07_share
    })
    ...
    rows.append({
        ...
        'level3': 'Walk-to-Transit',
        'level4': 'CRT_08',
        'value': walk_transit_base * wcrt08_share
    })
    ...
    rows.append({
        ...
        'level3': 'Drive-to-Transit',
        'level4': 'CRT_00',
        'value': drive_transit_base * dcrt00_share
    })
    ...
    rows.append({
        ...
        'level3': 'Drive-to-Transit',
        'level4': 'CRT_01',
        'value': drive_transit_base * dcrt01_share
    })
    ...
    rows.append({
        ...
        'level3': 'Drive-to-Transit',
        'level4': 'CRT_02',
        'value': drive_transit_base * dcrt02_share
    })
    ...
    rows.append({
        ...
        'level3': 'Drive-to-Transit',
        'level4': 'CRT_03',
        'value': drive_transit_base * dcrt03_share
    })
    ...
    rows.append({
        ...
        'level3': 'Drive-to-Transit',
        'level4': 'CRT_04',
        'value': drive_transit_base * dcrt04_share
    })
    ...
    rows.append({
        ...
        'level3': 'Drive-to-Transit',
        'level4': 'CRT_05',
        'value': drive_transit_base * dcrt05_share
    })
    ...
    rows.append({
        ...
        'level3': 'Drive-to-Transit',
        'level4': 'CRT_06',
        'value': drive_transit_base * dcrt06_share
    })
    ...
    rows.append({
        ...
        'level3': 'Drive-to-Transit',
        'level4': 'CRT_07',
        'value': drive_transit_base * dcrt07_share
    })
    ...
    rows.append({
        ...
        'level3': 'Drive-to-Transit',
        'level4': 'CRT_08',
        'value': drive_transit_base * dcrt08_share
    })
